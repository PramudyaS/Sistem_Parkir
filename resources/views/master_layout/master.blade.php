...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	<a href="" class="navbar-brand" style="font-family: 'Bangers', cursive;">PSpark</span>	</a>

	<div class="collapse navbar-collapse">
		<ul class="navbar-nav mr-auto">
			<li class="nav-item active">
				<a href="/home" class="nav-link">Home <span class="sr-only"></span></a>
			</li>
			...
			<li class="nav-item dropdown">
				<a href="#" class="nav-link dropdown-toggle" id="data" data-toggle="dropdown" role="button">Data Parkir
				</a>
				<div class="dropdown-menu">
					<a href="/transaksi/DataParkiranMasuk" class="dropdown-item">Kendaraan Masuk</a>
					<a href="/transaksi/DataParkiranKeluar" class="dropdown-item">Kendaraan Keluar</a>
				</div>
			</li>
			@endif
